...
public class GetLoginGoogleQueryHandler(IRepositoryBase<User, Guid> repositoryBase, IJwtTokenService jwtTokenService, IPasswordHasherService passwordHasherService) : IQueryHandler<Query.LoginGoogle, Response.Authenticated>
{
